...
class AddDataToFirestore {
  ...
  */
  void addTradeToFirebase(
      context,
      path,
      file,
      controller,
      TextEditingController titleController,
      TextEditingController tradeWithController,
      TextEditingController desController) async {
    try {
      ...
      if (tradeWithController.text.isEmpty ||
        ...
        ReturnWidgets().returnBottomSheet(
            context, "Please Fill all the fields and tryagain");
      ...
      firestore.collection("Trade").doc(DateTime.now().toString()).set({
  ...
  */
  ...
  void addEWasteToFirebase(
    ...
    try {
      ...
      firestore.collection("EWaste").doc(DateTime.now().toString()).set({
        TradeFormModel().title: titleController.text.trim().capitalize,
        TradeFormModel().tradeWith: tradeWithController.text.trim().capitalize,
        TradeFormModel().userId: auth.currentUser!.uid,
        TradeFormModel().isAuction: false,
